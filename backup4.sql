...
CREATE TABLE IF NOT EXISTS "student_guardians" ("id" integer primary key autoincrement not null, "student_id" integer not null, "guardian_id" integer not null, "created_at" datetime, "updated_at" datetime, foreign key("student_id") references "users"("id") on delete cascade, foreign key("guardian_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "classrooms" ("id" integer primary key autoincrement not null, "name" varchar not null, "mentor_id" integer not null, "created_at" datetime, "updated_at" datetime, "description" text, "status" varchar not null default 'ACTIVE', foreign key("mentor_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "classroom_students" ("id" integer primary key autoincrement not null, "classroom_id" integer not null, "student_id" integer not null, "created_at" datetime, "updated_at" datetime, foreign key("classroom_id") references "classrooms"("id") on delete cascade, foreign key("student_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "class_memberships" ("id" integer primary key autoincrement not null, "class_id" integer not null, "student_id" integer not null, "status" varchar not null default 'ACTIVE', "assigned_by_admin_id" integer, "assigned_at" datetime not null default CURRENT_TIMESTAMP, "ended_at" datetime, "created_at" datetime, "updated_at" datetime, foreign key("class_id") references "classrooms"("id") on delete cascade, foreign key("student_id") references "users"("id") on delete cascade, foreign key("assigned_by_admin_id") references "users"("id") on delete set null);
CREATE TABLE IF NOT EXISTS "daily_reflections" ("id" integer primary key autoincrement not null, "student_id" integer not null, "ref_date" date not null, "mood" varchar not null, "note" text, "created_at" datetime, "updated_at" datetime, foreign key("student_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "mentor_feedbacks" ("id" integer primary key autoincrement not null, "class_id" integer not null, "mentor_id" integer not null, "student_id" integer not null, "feedback_date" date not null, "message" text not null, "created_at" datetime, "updated_at" datetime, foreign key("class_id") references "classrooms"("id") on delete cascade, foreign key("mentor_id") references "users"("id") on delete cascade, foreign key("student_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "habit_logs" ("id" integer primary key autoincrement not null, "habit_id" integer not null, "log_date" date not null, "status" varchar not null default ('completed'), "created_at" datetime, "updated_at" datetime, "student_id" integer, "logged_at" datetime, foreign key("habit_id") references habits("id") on delete cascade on update no action, foreign key("student_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "student_profiles" ("id" integer primary key autoincrement not null, "user_id" integer not null, "birth_date" date, "school_name" varchar, "school_address" varchar, "grade_level" integer, "school_level" varchar, "guardian_name" varchar, "guardian_phone" varchar, "created_at" datetime, "updated_at" datetime, foreign key("user_id") references "users"("id") on delete cascade);
CREATE TABLE IF NOT EXISTS "genetic_types" ("id" integer primary key autoincrement not null, "name" varchar not null, "description" text, "created_at" datetime, "updated_at" datetime);
CREATE TABLE IF NOT EXISTS "users" ("id" integer primary key autoincrement not null, "name" varchar not null, "username" varchar not null, "email" varchar not null, "email_verified_at" datetime, "password" varchar not null, "remember_token" varchar, "created_at" datetime, "updated_at" datetime, "genetic_type_id" integer, foreign key("genetic_type_id") references "genetic_types"("id") on delete set null);
...
CREATE TABLE IF NOT EXISTS "habit_user" ("id" integer primary key autoincrement not null, "habit_id" integer not null, "student_id" integer not null, "color" varchar, "frequency" varchar not null default 'daily', "is_active" tinyint(1) not null default '1', "created_at" datetime, "updated_at" datetime, foreign key("habit_id") references "habits"("id") on delete cascade, foreign key("student_id") references "users"("id") on delete cascade);
DELETE FROM sqlite_sequence;
INSERT INTO sqlite_sequence VALUES('migrations',21);
INSERT INTO sqlite_sequence VALUES('habit_logs',0);
INSERT INTO sqlite_sequence VALUES('users',9);
INSERT INTO sqlite_sequence VALUES('habits',1);
INSERT INTO sqlite_sequence VALUES('habit_categories',7);
INSERT INTO sqlite_sequence VALUES('habit_user',0);
