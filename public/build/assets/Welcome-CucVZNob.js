...
const b = {
    ...
    F = { class: "relative w-full max-w-2xl px-6 lg:max-w-7xl" },
    y = { class: "grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3" },
    D = { key: 0, class: "-mx-3 flex flex-1 justify-end" },
    z = { class: "mt-6" },
    M = { class: "grid gap-6 lg:grid-cols-2 lg:gap-8" },
    Z = {
    ...
    L = { class: "py-16 text-center text-sm text-black dark:text-white/70" },
    B = {
        __name: "Welcome",
        props: {
            canLogin: { type: Boolean },
            canRegister: { type: Boolean },
            laravelVersion: { type: String, required: !0 },
            phpVersion: { type: String, required: !0 },
        },
        setup(r) {
            function x() {
                var s, e, d, h;
                ((s = document.getElementById("screenshot-container")) ==
                    null || s.classList.add("!hidden"),
                    (e = document.getElementById("docs-card")) == null ||
                        e.classList.add("!row-span-1"),
                    (d = document.getElementById("docs-card-content")) ==
                        null || d.classList.add("!flex-row"),
                    (h = document.getElementById("background")) == null ||
